...
const spritesOnly = process.argv.includes("--sprites-only");

const MOBILE_ASSETS = Object.freeze([
  { source: "player-home-v1.png", destination: "player-home-v1.webp", quality: 82, maxBytes: 350_000 },
  { source: "elverson-ground-v5.png", destination: "elverson-ground-v5.webp", quality: 82, maxBytes: 650_000 },
  ...
  {
    source: "player-sprites-512-v3.png",
    destination: "player-sprites-512-v3.webp",
    quality: 100,
    lossless: true,
    maxBytes: 200_000,
  },
  { source: "marina-sprites-512-v3.png", destination: "marina-sprites-512-v3.webp", quality: 90, maxBytes: 90_000 },
  { source: "dorian-sprites-512-v3.png", destination: "dorian-sprites-512-v3.webp", quality: 90, maxBytes: 75_000 },
  { source: "fisherman-wyeth-sprites-512-v3.png", destination: "fisherman-wyeth-sprites-512-v3.webp", quality: 90, maxBytes: 70_000 },
  { source: "teacher-caroline-sprites-512-v3.png", destination: "teacher-caroline-sprites-512-v3.webp", quality: 90, maxBytes: 60_000 },
  { source: "ivy-sprites-512-v3.png", destination: "ivy-sprites-512-v3.webp", quality: 90, maxBytes: 85_000 },
  { source: "explorer-jordan-sprites-512-v3.png", destination: "explorer-jordan-sprites-512-v3.webp", quality: 90, maxBytes: 65_000 },
  { source: "marine-biologist-jonah-sprites-512-v3.png", destination: "marine-biologist-jonah-sprites-512-v3.webp", quality: 90, maxBytes: 60_000 },
  { source: "programmer-harlan-sprites-512-v3.png", destination: "programmer-harlan-sprites-512-v3.webp", quality: 90, maxBytes: 60_000 },
  { source: "town-elder-sprites-512-v3.png", destination: "town-elder-sprites-512-v3.webp", quality: 90, maxBytes: 70_000 },
  { source: "town-adult-sprites-512-v3.png", destination: "town-adult-sprites-512-v3.webp", quality: 90, maxBytes: 60_000 },
  { source: "mr-easterling-sprites-627-v4.png", destination: "mr-easterling-sprites-627-v4.webp", quality: 90, maxBytes: 75_000 },
...
for (const asset of MOBILE_ASSETS) {
  if (spritesOnly && !asset.destination.includes("sprites")) continue;
