...
export const ELVERSON_LEGACY_AMBIENT_RESIDENTS = [
  {
    ...
    patrol: {
      ...
      waypoints: [{ x: 10.8, y: 16.45 }, { x: 11.8, y: 16.45 }],
    },
  },
  {
    id: "teacher-caroline",
  ...
  },
  {
    ...
    returnLine: "When you're ready for a shoreline survey, find me on the east end of Main Street and we'll walk down together.",
    patrol: {
      mode: "ping-pong",
      speed: 0.5,
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 21, y: 10.35 }, { x: 22.6, y: 10.35 }],
    },
  },
  {
    id: "sam",
    ...
    returnLine: "I'll be around the west end of Main Street if you want to compare notes.",
  },
  {
    id: "finn",
    name: "Finn",
    ...
    returnLine: "I'll be walking Main Street. It is a good place to hear what the whole town has noticed.",
    patrol: {
      mode: "ping-pong",
      speed: 0.46,
      pauseMs: 1000,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 10.8, y: 10.35 }, { x: 12.2, y: 10.35 }],
    },
  },
  {
    id: "ellis",
  ...
  },
  {
    ...
    returnLine: "I'll be near the east end of Main Street if you want to compare today's water with your earlier notes.",
  },
  {
    id: "henderson",
    name: "Henderson",
  ...
  },
  {
    ...
    returnLine: "I'll keep sketching along the park path. Tell me when the exhibit needs an illustration.",
    patrol: {
      mode: "ping-pong",
      speed: 0.4,
      pauseMs: 1400,
      playerPauseDistance: 1.2,
      // This west-side park path stays clear of the fountain and benches and
      // leaves the Chestnut doorway corridor open even while Charlotte walks.
      waypoints: [{ x: 15, y: 4 }, { x: 15, y: 6.8 }],
    },
  },
  {
    id: "eli",
  ...
  },
  {
    ...
    returnLine: "I'll stay near the eastern path. Bring a field note if you spot a difference you cannot explain yet.",
  },
  {
    id: "emilio",
    name: "Emilio",
    ...
    sceneId: "town",
    at: { x: 24, y: 10.35 },
    intro: "Hi, I'm Emilio. I'm checking Main Street before visitors start arriving at the aquarium.",
    guidance: "Clear signs and open paths help people enjoy the shore without stepping into sensitive habitat.",
    returnLine: "I'll keep moving along the east end of Main Street. Let me know if an exhibit direction is hard to follow.",
    patrol: {
      mode: "ping-pong",
      speed: 0.44,
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 24, y: 10.35 }, { x: 25.2, y: 10.35 }],
    },
  },
  {
    id: "henry",
