...
const ELVERSON_AMBIENT_RESIDENTS = [
  {
    ...
    patrol: {
      ...
      speed: 0.42,
      pauseMs: 1500,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 14, y: 14 }, { x: 14, y: 15 }],
    },
  },
  {
    id: "teacher-caroline",
    name: "Teacher Caroline",
    title: "Elverson Teacher",
    sceneId: "town",
    at: { x: 9, y: 7 },
    intro: "Hello there! Mr. Easterling told my class about the aquarium exhibit. We would love to help make its signs clear and accurate.",
    guidance: "A good exhibit label answers three questions: what lives here, what does it need, and what can visitors do to protect it?",
    returnLine: "Bring me your observations when you're ready. We can turn them into words every visitor can understand.",
  },
  {
    id: "ivy",
    name: "Ivy",
    title: "Elverson Resident",
    sceneId: "town",
    at: { x: 3, y: 7 },
    intro: "Hi! I'm Ivy. I pass this corner every day, so I'm curious to see how the aquarium changes as everyone pitches in.",
    guidance: "The best town projects leave room for people to ask questions and share what they have noticed.",
    returnLine: "I'll keep an eye out for anything along Main Street that might help the exhibit.",
  },
  {
    id: "explorer-jordan",
    name: "Explorer Jordan",
    title: "Shoreline Explorer",
    sceneId: "town",
    at: { x: 21, y: 10.65 },
    intro: "Explorer Jordan, at your service! The shoreline is our first field site, but we observe before we collect anything.",
    guidance: "Look for shelter, food, water movement, and signs of stress. A habitat is more than a pretty backdrop.",
    returnLine: "When you're ready for a shoreline survey, follow the promenade and find me near the eastern overlook.",
    patrol: {
      mode: "ping-pong",
      speed: 0.5,
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 21, y: 10.65 }, { x: 22.5, y: 10.65 }],
    },
  },
  {
    id: "sam",
    ...
    sceneId: "town",
    at: { x: 3, y: 10.65 },
    intro: "Hey! I'm Sam. The ocean makes our little town feel bigger, but it also means we have to take care of what washes downstream.",
    guidance: "Even far from the pier, litter and stormwater can eventually reach the shore.",
    returnLine: "I'll be around the west end of the promenade if you want to compare notes.",
  },
  {
    id: "finn",
    name: "Finn",
    ...
    sceneId: "town",
    at: { x: 12, y: 10.65 },
    intro: "I'm Finn. I came down to see whether the fishing boat had returned—and to hear more about the new aquarium.",
    guidance: "Wyeth knows the harbor better than anyone. Watch how he handles gear around wildlife.",
    returnLine: "I'll be walking the waterfront. It is a good place to notice how the tide changes.",
    patrol: {
      mode: "ping-pong",
      speed: 0.46,
      pauseMs: 1000,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 12, y: 10.65 }, { x: 10, y: 10.65 }],
    },
  },
  {
    id: "ellis",
    ...
    sceneId: "town",
    at: { x: 10.6, y: 5 },
    intro: "Hello! I'm Ellis. The park is a good reminder that every healthy place depends on many living things working together.",
    guidance: "When you study the coast, look for relationships—not just individual animals.",
    returnLine: "I'll be near the park if you want a quiet place to think through your observations.",
  },
  {
    id: "luke",
    name: "Luke",
    ...
    sceneId: "town",
    at: { x: 8, y: 10.65 },
    intro: "Hi, I'm Luke. Everyone has been talking about the empty aquarium room. I can't wait to see the first exhibit take shape.",
    guidance: "Starting with an empty tank is smart. The habitat and care plan should come before its animals.",
    returnLine: "Come find me after you visit the aquarium. I want to hear what Mr. Easterling has planned.",
  },
  {
    id: "karah",
    name: "Karah",
    ...
    sceneId: "town",
    at: { x: 20, y: 7 },
    intro: "Welcome to Elverson! I'm Karah. Main Street gets busy, but the park paths are perfect for slowing down and noticing details.",
    guidance: "A careful field note says what you actually observed before it says what you think it means.",
    returnLine: "I'll be near the crossroads if you need help finding the park, homes, or waterfront.",
  },
  {
    id: "calvin",
    name: "Calvin",
    ...
    sceneId: "town",
    at: { x: 3.5, y: 6.1 },
    intro: "Name's Calvin. Main Street runs straight through town; follow Chestnut south and you cannot miss the ocean.",
    guidance: "The aquarium is at the end of the pier, and Fisherman Wyeth usually works nearby.",
    returnLine: "If you lose your bearings, come back to the Main and Chestnut crossroads.",
  },
  {
    id: "landon",
    name: "Landon",
    ...
    sceneId: "town",
    at: { x: 19.75, y: 10.5 },
    intro: "I'm Landon. I like watching the waves from here, especially when the wind changes their shape.",
    guidance: "Conditions can change quickly along the water. Record the time and weather with every observation.",
    returnLine: "I'll be close to the seawall if you want to compare today's water with your earlier notes.",
  },
  {
    id: "henderson",
    name: "Henderson",
    ...
    sceneId: "town",
    at: { x: 27, y: 7 },
    intro: "Hello, I'm Henderson. You picked a fine day to explore Elverson—Main Street is lively and the waterfront is clear.",
    guidance: "Talk to people more than once. A town project improves when its neighbors can respond to what changed.",
    returnLine: "I'll be on the east side of Main Street if you need a local opinion.",
  },
  {
    id: "charlotte",
    name: "Charlotte",
    ...
    sceneId: "town",
    at: { x: 14, y: 3 },
    intro: "Hi! I'm Charlotte. I like sketching in the park because sitting still helps me notice shapes and patterns.",
    guidance: "A drawing can preserve details a quick photograph misses. Label what you know and what you still need to identify.",
    returnLine: "I'll keep circling the park. Tell me when the exhibit needs an illustration.",
    patrol: {
      mode: "loop",
      speed: 0.4,
      pauseMs: 1400,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 14, y: 3 }, { x: 15, y: 3 }, { x: 15, y: 7 }, { x: 14, y: 7 }],
    },
  },
  {
    id: "eli",
    ...
    sceneId: "town",
    at: { x: 17, y: 6.75 },
    intro: "Hey, I'm Eli. The fountain is my favorite meeting spot because every part of town connects back to it.",
    guidance: "North leads through the park, east and west follow Main Street, and south takes you to the aquarium pier.",
    returnLine: "Meet me by the park if you want directions without opening a map.",
  },
  {
    id: "william",
    name: "William",
    ...
    sceneId: "town",
    at: { x: 27, y: 10.65 },
    intro: "I'm William. The eastern seawall is a good place to compare calm water with the waves around the rocks.",
    guidance: "Two nearby places can shelter very different communities when their depth, current, or exposure changes.",
    returnLine: "I'll stay near the overlook. Bring a field note if you spot a difference you cannot explain yet.",
  },
  {
    id: "emilio",
    name: "Emilio",
    ...
    sceneId: "town",
    at: { x: 24, y: 10.65 },
    intro: "Hi, I'm Emilio. I'm checking the promenade before visitors start arriving at the aquarium.",
    guidance: "Clear signs and open paths help people enjoy the shore without stepping into sensitive habitat.",
    returnLine: "I'll keep moving along the east promenade. Let me know if an exhibit direction is hard to follow.",
    patrol: {
      mode: "ping-pong",
      speed: 0.44,
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 24, y: 10.65 }, { x: 25.5, y: 10.65 }],
    },
  },
  {
    id: "henry",
    ...
    sceneId: "coral-home",
    at: { x: 4, y: 5 },
    intro: "Hello! I'm Henry. It is nice having a town project that gives everyone a reason to share what they know.",
    guidance: "Ask one careful question at a time. Good questions make observations easier to compare.",
    returnLine: "I'll be here if you want to talk through another question.",
  },
  {
    id: "jack",
    name: "Jack",
    ...
    sceneId: "coral-home",
    at: { x: 6, y: 5 },
    intro: "I'm Jack. I heard the aquarium team needs help, so I'm collecting ideas from around town.",
    guidance: "An idea becomes useful when you can connect it to evidence or test it safely.",
    returnLine: "Tell me what you learn at the pier. I'll help keep the ideas organized.",
  },
  {
    id: "eloise",
    name: "Eloise",
    ...
    sceneId: "coral-home",
    at: { x: 5, y: 4 },
    intro: "Hello, I'm Eloise. A welcoming exhibit should make people curious without pretending we know everything.",
    guidance: "It is perfectly scientific to label an unanswered question. That tells visitors what researchers may study next.",
    returnLine: "Come back when you have a mystery worth adding to the exhibit.",
  },
  {
    id: "oliver",
    name: "Oliver",
    ...
    sceneId: "deep-home",
    at: { x: 4, y: 5 },
    intro: "Hi, I'm Oliver. The best part of living here is hearing how one discovery turns into the next question.",
    guidance: "Keep your field notes even when the answer seems obvious. Later evidence may change the story.",
    returnLine: "I'll be here comparing notes if you want another set of eyes.",
  },
  {
    id: "edith",
    name: "Edith",
    ...
    sceneId: "deep-home",
    at: { x: 6, y: 5 },
    intro: "Welcome, dear. I'm Edith. An aquarium can be a window into the ocean if it treats its living guests with care.",
    guidance: "A beautiful display is never worth poor animal welfare. Let the care plan guide every choice.",
    returnLine: "Visit again after you speak with Jonah. I would like to hear how the habitat plan develops.",
  },
  {
    id: "micah",
    name: "Micah",
    ...
    sceneId: "deep-home",
    at: { x: 5, y: 4 },
    intro: "I'm Micah. I have been wondering what the aquarium will sound like once the pumps and water are running.",
    guidance: "Aquarium equipment supports the habitat even when visitors barely notice it. Reliable systems matter.",
    returnLine: "Let me know what Harlan records about the equipment plan.",
  },
  {
  ...
  },
  {
    ...
    title: "Aquarium Systems Programmer",
    sceneId: "academy-lab",
    at: { x: 6, y: 6 },
    intro: "Hi, I'm Harlan. I keep the aquarium catalog, observations, and equipment checks organized so good information does not get lost.",
    guidance: "Save your work from the menu after a useful discovery. Your inventory and Field Notes will help the team track what belongs in the exhibit.",
    returnLine: "When you bring back a new observation, I'll add it to the aquarium record and verify that it saved correctly.",
  },
];
...
const shellshoreRuntimeScenes = {
  town: {
    ...
    artPath: "/images/adventure/elverson-town.png",
    tiles: Array.from({ length: 20 }, () => "g".repeat(30)),
    spawn: { x: 14, y: 10 },
    startFacing: "up",
    collisionRects: [
      { id: "elverson-west-boundary", left: 0, top: 0, right: 0.7, bottom: 12.5 },
      { id: "elverson-east-boundary", left: 28.8, top: 0, right: 29.5, bottom: 12.5 },
      { id: "elverson-northwest-woods", left: 0.7, top: 0, right: 14, bottom: 0.7 },
      { id: "elverson-northeast-woods", left: 16, top: 0, right: 28.8, bottom: 0.7 },
      { id: "elverson-northwest-canopy", left: 0.7, top: 0.7, right: 7.8, bottom: 2.05 },
      { id: "elverson-west-upper-hillside", left: 0.7, top: 2.05, right: 1.25, bottom: 5.45 },
      { id: "elverson-west-lower-hillside", left: 0.7, top: 5.45, right: 2.35, bottom: 6.65 },
      { id: "elverson-west-garden-hillside", left: 4.2, top: 5.45, right: 5.65, bottom: 6.65 },
      { id: "elverson-north-central-trees", left: 12.15, top: 0.7, right: 13.2, bottom: 2.6 },
      { id: "elverson-far-northeast-canopy", left: 25.75, top: 0.7, right: 27.75, bottom: 3.75 },
      { id: "elverson-east-hillside", left: 26.65, top: 3.75, right: 27.75, bottom: 6.65 },
      { id: "elverson-west-residence", left: 1.25, top: 2.05, right: 5.15, bottom: 5.45 },
      { id: "elverson-northwest-residence", left: 8.05, top: 0.85, right: 12.15, bottom: 3.45 },
      { id: "elverson-northeast-residence-left", left: 15.95, top: 0.55, right: 17.55, bottom: 3.65 },
      { id: "elverson-northeast-residence-door-cap", left: 17.55, top: 0.55, right: 18.3, bottom: 2.7 },
      { id: "elverson-northeast-residence-right", left: 18.3, top: 0.55, right: 19.65, bottom: 3.65 },
      { id: "elverson-far-northeast-residence", left: 20.6, top: 0.85, right: 24.25, bottom: 3.75 },
      { id: "elverson-school-left", left: 5.65, top: 3.45, right: 6.55, bottom: 6.55 },
      { id: "elverson-school-door-cap", left: 6.55, top: 3.45, right: 7.45, bottom: 5.55 },
      { id: "elverson-school-right", left: 7.45, top: 3.45, right: 10.15, bottom: 6.55 },
      { id: "elverson-town-hall", left: 20.45, top: 3.65, right: 25.75, bottom: 6.75 },
      { id: "elverson-west-shop", left: 0.7, top: 7.75, right: 3.9, bottom: 10.3 },
      { id: "elverson-main-street-brick-shop", left: 4.5, top: 7.75, right: 7.3, bottom: 10.3 },
      { id: "elverson-main-street-blue-shop", left: 7.6, top: 7.75, right: 10.3, bottom: 10.3 },
      { id: "elverson-main-street-gold-shop", left: 16.5, top: 7.75, right: 19.3, bottom: 10.3 },
      { id: "elverson-main-street-green-home", left: 20.15, top: 7.75, right: 23.15, bottom: 10.3 },
      { id: "elverson-main-street-east-home", left: 23.15, top: 7.75, right: 26.35, bottom: 10.3 },
      { id: "elverson-park-north-bench", left: 15.65, top: 3.65, right: 16.45, bottom: 4.2 },
      { id: "elverson-park-east-bench", left: 16.75, top: 4.35, right: 17.55, bottom: 4.95 },
      { id: "elverson-park-fountain", left: 15.9, top: 4.6, right: 17.25, bottom: 5.85 },
      { id: "elverson-park-west-garden-bed", left: 11.05, top: 3.65, right: 13.35, bottom: 6.65 },
      { id: "elverson-park-south-bench", left: 15.7, top: 6.3, right: 16.5, bottom: 6.65 },
      { id: "elverson-park-east-tree-bed", left: 17.45, top: 4.55, right: 19.25, bottom: 6.65 },
      { id: "elverson-park-lamppost", left: 15.48, top: 6.43, right: 15.62, bottom: 6.65 },
      { id: "elverson-main-street-west-planter", left: 11.05, top: 8.15, right: 13.35, bottom: 10.15 },
      { id: "elverson-main-street-east-planter", left: 14.5, top: 8.15, right: 16.4, bottom: 10.15 },
      { id: "elverson-main-west-lamppost", left: 11.5, top: 7.95, right: 11.7, bottom: 8.15 },
      { id: "elverson-main-east-lamppost", left: 15.5, top: 7.95, right: 15.7, bottom: 8.15 },
      { id: "elverson-west-promenade-bench", left: 4.65, top: 11, right: 5.55, bottom: 11.45 },
      { id: "elverson-east-promenade-bench", left: 16.65, top: 11, right: 17.55, bottom: 11.45 },
      { id: "elverson-central-promenade-lamppost", left: 14.85, top: 11.3, right: 15.05, bottom: 11.55 },
      { id: "elverson-east-promenade-lamppost", left: 18.85, top: 11.3, right: 19.05, bottom: 11.55 },
      { id: "elverson-far-east-promenade-lamppost", left: 26.3, top: 10.73, right: 26.5, bottom: 10.95 },
      { id: "elverson-west-seawall-rail", left: 0.7, top: 11.6, right: 12.85, bottom: 12.45 },
      { id: "elverson-east-seawall-rail", left: 14.85, top: 11.6, right: 28.8, bottom: 12.45 },
      { id: "elverson-west-shore-water", left: 0, top: 12.45, right: 12.85, bottom: 14.5 },
      { id: "elverson-east-shore-water", left: 14.85, top: 12.45, right: 29.5, bottom: 14.5 },
      { id: "elverson-west-deep-water", left: 0, top: 14.5, right: 9, bottom: 19.5 },
      { id: "elverson-east-deep-water", left: 22.5, top: 14.5, right: 29.5, bottom: 19.5 },
      { id: "elverson-fishing-dock-north-water", left: 9, top: 14, right: 13, bottom: 15.1 },
      { id: "elverson-fishing-dock-east-water", left: 12.9, top: 15.1, right: 13.2, bottom: 16.65 },
      { id: "elverson-fishing-dock-south-water", left: 9, top: 17.5, right: 13.2, bottom: 19.5 },
      { id: "elverson-aquarium-west-water", left: 14.85, top: 14.5, right: 15.45, bottom: 15.4 },
      { id: "elverson-aquarium-east-water", left: 20.85, top: 14.5, right: 22.5, bottom: 19.5 },
      { id: "elverson-aquarium-south-water", left: 14.85, top: 16.4, right: 20.85, bottom: 19.5 },
      { id: "elverson-fishing-boat", left: 9.8, top: 13.85, right: 12.9, bottom: 16.65 },
      { id: "elverson-aquarium-left", left: 15.45, top: 13.15, right: 15.55, bottom: 15.4 },
      { id: "elverson-aquarium-door-cap", left: 15.55, top: 13.15, right: 16.45, bottom: 15.4 },
      { id: "elverson-aquarium-right", left: 16.45, top: 13.15, right: 20.45, bottom: 15.4 },
    ],
    interactions: [
      {
  ...
  })),
  {
    ...
    lines: {
      ...
      victory: [
        ...
        "That ecosystem is our first model for the exhibit. Next, we'll work with Jonah, Wyeth, Jordan, Caroline, and Harlan to study Elverson's shore and plan the real display responsibly.",
      ],
      starterPresentation: [
        ...
        "Every starter is a complete 60-card deck and can complete the whole aquarium lesson. Pick the strategy that sounds most fun to you.",
      ],
      starterConfirmed: [
  ...
  },
  {
    ...
    lines: {
      ...
      victory: [
        ...
        "The Abyss Crest is yours. Elverson has another strong Reefkeeper helping its aquarium project.",
      ],
    },
  },
  {
...
const fieldNotes = [
  {
    ...
    title: "Elverson Shore & Aquarium Planning",
    habitatId: "harbor-lagoon",
    status: "prototype",
    ...
    observations: [
      "Elverson's coast contains connected habitats, including rocky shore, dock pilings, shallow sand, and sheltered water.",
    ...
    safetyChecklist: [
      "Wear a life jacket and check the weather and tide before working near the pier.",
      "Tell an adult the field plan, keep clear of working boats, and stay on public walkways.",
      "Give wildlife space, release catches as instructed, and bring every piece of gear home.",
    ],
    glossary: [
...
const learningPlans = {
  "quest-shellshore-first-voyage": {
    ...
    evidence: ["Compare organisms and physical conditions at two Elverson shoreline points.", "Record habitat needs before proposing an aquarium resident."],
    decision: "Choose which observations belong in Elverson's first aquarium exhibit and which questions still need evidence.",
    consequence: "Mr. Easterling and Jonah approve a responsible first exhibit plan and correct unsupported conclusions.",
    debrief: "Explain why habitat, water quality, animal care, and visitor learning must be planned together.",
    callback: "Use the same observation-first approach whenever the Elverson exhibit expands.",
  },
...
const questDefinitions = [
  ["quest-shellshore-first-voyage", "shellshore-village", "Elverson's First Exhibit", "dialogue-shellshore-first-voyage", "reward-shellshore-tutorial"],
