...
const ELVERSON_AMBIENT_RESIDENTS = [
  ...
  },
  {
    ...
    patrol: {
      ...
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 21, y: 11 }, { x: 22.5, y: 11 }],
    },
  },
  {
    id: "sam",
  ...
  },
  {
    ...
    patrol: {
      ...
      pauseMs: 1200,
      playerPauseDistance: 1.2,
      waypoints: [{ x: 24, y: 11 }, { x: 25.5, y: 11 }],
    },
  },
  {
    id: "henry",
...
const shellshoreRuntimeScenes = {
  town: {
    ...
    collisionRects: [
      ...
      { id: "elverson-northeast-residence-left", left: 15.55, top: 0.55, right: 17.55, bottom: 3.65 },
      { id: "elverson-northeast-residence-door-cap", left: 17.55, top: 0.55, right: 18.45, bottom: 2.7 },
      { id: "elverson-northeast-residence-right", left: 18.45, top: 0.55, right: 20.25, bottom: 3.65 },
      { id: "elverson-far-northeast-residence", left: 21.25, top: 0.85, right: 25.75, bottom: 3.75 },
      ...
      { id: "elverson-school-right", left: 7.45, top: 3.45, right: 10.55, bottom: 6.55 },
      { id: "elverson-town-hall", left: 21.25, top: 3.65, right: 26.65, bottom: 6.75 },
      { id: "elverson-west-shop", left: 1.1, top: 8.15, right: 4.35, bottom: 10.3 },
      { id: "elverson-main-street-brick-shop", left: 5.1, top: 8.15, right: 7.85, bottom: 10.3 },
      { id: "elverson-main-street-blue-shop", left: 8.1, top: 8.15, right: 10.95, bottom: 10.3 },
      { id: "elverson-main-street-gold-shop", left: 17.15, top: 8.2, right: 20.2, bottom: 10.3 },
      { id: "elverson-main-street-green-home", left: 20.75, top: 8.15, right: 23.4, bottom: 10.3 },
      { id: "elverson-main-street-east-home", left: 24.1, top: 8.15, right: 27.55, bottom: 10.3 },
      ...
      { id: "elverson-park-west-bench", left: 12.55, top: 5.95, right: 13.35, bottom: 6.5 },
      { id: "elverson-park-south-bench", left: 15.7, top: 6.3, right: 16.5, bottom: 6.65 },
      { id: "elverson-park-west-planter", left: 11.75, top: 3.7, right: 12.55, bottom: 4.55 },
      { id: "elverson-park-east-hedge", left: 18.15, top: 4.85, right: 19.15, bottom: 5.75 },
      { id: "elverson-park-lamppost", left: 15.45, top: 6.05, right: 15.65, bottom: 6.65 },
      { id: "elverson-main-west-lamppost", left: 11.42, top: 7.5, right: 11.78, bottom: 8.15 },
      { id: "elverson-main-east-lamppost", left: 15.42, top: 7.5, right: 15.78, bottom: 8.15 },
      ...
      { id: "elverson-central-promenade-lamppost", left: 14.75, top: 10.7, right: 15.15, bottom: 11.55 },
      { id: "elverson-east-promenade-lamppost", left: 18.75, top: 10.7, right: 19.15, bottom: 11.55 },
      { id: "elverson-far-east-promenade-lamppost", left: 26.2, top: 10.25, right: 26.6, bottom: 10.95 },
      { id: "elverson-west-seawall-rail", left: 0.7, top: 11.6, right: 13.1, bottom: 12.45 },
      { id: "elverson-east-seawall-rail", left: 15.9, top: 11.6, right: 28.8, bottom: 12.45 },
      { id: "elverson-west-shore-water", left: 0, top: 12.45, right: 13, bottom: 14.5 },
      { id: "elverson-east-shore-water", left: 16, top: 12.45, right: 29.5, bottom: 14.5 },
      { id: "elverson-west-deep-water", left: 0, top: 14.5, right: 9.5, bottom: 19.5 },
      { id: "elverson-east-deep-water", left: 22.5, top: 14.5, right: 29.5, bottom: 19.5 },
      { id: "elverson-fishing-dock-north-water", left: 9.5, top: 14.5, right: 13.2, bottom: 15.45 },
      { id: "elverson-fishing-dock-west-water", left: 9.5, top: 15.45, right: 10.15, bottom: 18.2 },
      { id: "elverson-fishing-dock-east-water", left: 12.95, top: 15.45, right: 13.2, bottom: 16.5 },
      { id: "elverson-fishing-dock-south-water", left: 9.5, top: 18.2, right: 13.2, bottom: 19.5 },
      { id: "elverson-aquarium-east-water", left: 21.55, top: 14.5, right: 22.5, bottom: 17.75 },
      { id: "elverson-aquarium-south-water", left: 15.5, top: 17.75, right: 22.5, bottom: 19.5 },
      { id: "elverson-fishing-boat", left: 10.15, top: 15.45, right: 12.95, bottom: 17.1 },
      { id: "elverson-aquarium-left", left: 15.45, top: 13.15, right: 15.55, bottom: 17 },
      { id: "elverson-aquarium-door-cap", left: 15.55, top: 13.15, right: 16.45, bottom: 16.15 },
      { id: "elverson-aquarium-right", left: 16.45, top: 13.15, right: 21.55, bottom: 17 },
    ],
    interactions: [
      {
