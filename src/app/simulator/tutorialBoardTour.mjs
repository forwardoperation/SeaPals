...
export const GUIDED_ACADEMY_BOARD_TOUR_STEPS = Object.freeze([
  ...
  Object.freeze({
    ...
    message: "The Recent Events feed records draws, costs, card effects, attacks, and rules outcomes. If something resolves differently than you expected, this is the first place to look for the simulator's explanation.",
