...
export const coralCards = [
...

  {
    ...
    stage: 0,
    stageLabel: "Base",
    image: "/images/cards/coral/Reef/brain-coral-base.png",
    sortOrder: 30,
    cost: { rp: 1 },
    health: 10,
...

  {
    ...
    stage: 1,
    stageLabel: "Stage 1",
    image: "/images/cards/coral/Reef/brain-coral-stage-1.png",
    sortOrder: 31,
    cost: { rp: 2 },
    health: 20,
...

  {
    ...
    stage: 2,
    stageLabel: "Stage 2",
    image: "/images/cards/coral/Reef/brain-coral-stage-2.png",
    sortOrder: 32,
    cost: { rp: 5 },
    health: 60,
...

  {
    ...
    stage: 1,
    stageLabel: "Stage 1",
    image: "/images/cards/coral/Reef/clubfinger-stage-1.png",
    sortOrder: 61,
    cost: { rp: 2 },
    health: 30,
...

  {
    ...
    stage: 0,
    stageLabel: "Base",
    image: "/images/cards/coral/Reef/mustard-coral-base.png",
    sortOrder: 70,
    cost: { rp: 2 },
    health: 30,
