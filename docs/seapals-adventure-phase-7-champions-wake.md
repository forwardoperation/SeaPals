...
The latest live route check also measured a direction change on the rendered boat: the world-position anchor remained fixed while the hull interpolated through the shortest 140 ms turn. This closes the reported visual snap/teleport regression without changing movement collision or dock coordinates.
